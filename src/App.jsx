...
{/* Botón Instagram: Versión Universal (PC + Móvil) */}
<a 
...
>
    ...
    >
        <defs>
            {/* ID único para evitar conflictos con otros SVGs */}
            <radialGradient id="insta_universal" r="150%" cx="30%" cy="107%">
