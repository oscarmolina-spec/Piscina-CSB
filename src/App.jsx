...
{/* Botón Instagram: Versión Forzada para Perfil Directo */}
<a 
  href="https://www.instagram.com/cs_buenaventura/" 
  onClick={(e) => {
    // Intenta abrir la App directamente antes de que el navegador actúe
    const appUrl = "instagram://user?username=cs_buenaventura";
    window.location.href = appUrl;
    
    // Si en 0.5 segundos no se ha ido a la app, el navegador seguirá al href normal
  }}
  target="_blank" 
  rel="noopener noreferrer" 
...
>
    ...
    >
        <defs>
            <radialGradient id="insta_final_fix" r="150%" cx="30%" cy="107%">
