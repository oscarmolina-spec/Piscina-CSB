...
{/* Botón Instagram: Configuración Universal */}
<a 
  ...
  onClick={(e) => {
    // Detectamos si es móvil para intentar el salto directo
    const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
    if (isMobile) {
      // Este protocolo suele disparar la ventana emergente de "Abrir en Instagram"
...
>
    ...
    >
        <defs>
            <radialGradient id="insta_final_universal" r="150%" cx="30%" cy="107%">
        ...
        <path 
            fill="url(#insta_final_universal)" 
