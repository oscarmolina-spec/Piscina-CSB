...
{/* Botón Instagram: Versión Profesional Funcional */}
<button 
  onClick={() => {
    const user = "cs_buenaventura";
    // Intentamos abrir la App primero
    window.location.href = `instagram://user?username=${user}`;
    // Si en medio segundo no ha saltado a la App, abrimos la web
    setTimeout(() => {
...
>
    ...
    >
        <defs>
            <radialGradient id="insta_final_working" r="150%" cx="30%" cy="107%">
